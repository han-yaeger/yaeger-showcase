...
import nl.han.showcase.scenes.gravity.maps.other.Grass;
import nl.han.showcase.scenes.gravity.maps.ground.*;

/**
 * A rather large {@link TileMap} is used to create the ground.
 */
public class GroundMap extends TileMap {
    ...
    public int[][] defineMap() {
        int[][] map = {
                ...
                {NIL, NIL, NIL, NIL, NIL, NIL, NIL, NIL, NIL, NIL, NIL, NIL, NIL, NIL, NIL},
                {NIL, NIL, NIL, NIL, NIL, NIL, NIL, NIL, NIL, NIL, NIL, NIL, NIL, NIL, GRS},
                {NIL, NIL, NIL, NIL, NIL, NIL, NIL, NIL, NIL, NIL, NIL, NIL, NIL, NW1, NE2},
                {NIL, NIL, NIL, NIL, NIL, NIL, NIL, NIL, NIL, NIL, NIL, NIL, NIL, SW1, SE2},
                {NIL, NIL, NIL, NIL, NIL, NIL, NIL, NIL, NIL, NIL, NIL, NIL, NIL, NIL, NIL},
                ...
                {NIL, NIL, NIL, NIL, NIL, NIL, NW1, NW5, SE3, NIL, NIL, NIL, NIL, NIL, NIL},
                {NIL, NIL, NIL, NIL, NIL, NIL, SW1, SW5, SE3, NIL, NIL, NIL, NIL, NIL, NIL},
                {NIL, NIL, NIL, NIL, NIL, NIL, NIL, SW3, SE3, NIL, NIL, NIL, NIL, NIL, NIL},
